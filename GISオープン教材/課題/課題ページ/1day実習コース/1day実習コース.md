...
## 前半の課題
　下の図と同じように空中写真を背景にした地図を作成してください（どの年代でも可）。縮尺、方位記号、ポイントのデザインは、下の図と異なったものとします。
![kadai1](pic/Q1.png)

[▲メニューへもどる]

## 後半：視覚的な地形表現
　実習をはじめる前に、以下のデータを使用します。
...
## 後半の課題
　任意の地域のデータ（もしくは、配布された課題データ）を用いて、段彩図、傾斜区分図、斜面方位図のいずれかを作成してください。データを作成後、配色を整えてください。配色を調整した後、縮尺、方位記号、凡例を入れた地図を作成してください。

**完成例**

![kadai2](pic/yashima.png)
