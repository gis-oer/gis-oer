...
* [福知山豪雨災害聞き取り調査データ]　([福知山豪雨災害防災マップ] © 福知山豪雨災害防災マップ を加工し作成）
...
![インストール](./pic_qgis2_8/Qpic1-4.png)
...
![プロパティ](./pic_qgis2_8/Qpic32.png)

### 一般情報
一般情報は、座標系を確認したり、文字コード、表示名の変更ができる機能です。
![一般情報](./pic_qgis2_8/Qpic33.png)
...
![スタイルc](./pic_qgis2_8/Qpic36-1.png)
...
![プラグインのインストール](./pic_qgis2_8/Qpic15.png)

検索から、インストールしたいプラグインを検索する。例として、以下のような便利なプラグインがある。
![プラグインの例](./pic_qgis2_8/Qpic16.png)  
...
![TileLayerPlugin](./pic_qgis2_8/Qpic16-1.png)
...
![TileLayerPlugin](./pic_qgis2_8/Qpic16-2.png)
...
![TileLayerPlugin](./pic_qgis2_8/Qpic16-3.png)
...
![ビューa](./pic_qgis2_8/Qpic28.png)

以下のように、QGISのビュー上に縮尺と方位記号が表示される。
![ビューb](./pic_qgis2_8/Qpic29.png)
...
![DEMを変換](./pic_qgis2_8/15pic_3.png)
...
![ラスタの切りぬき](./pic_qgis2_8/15pic_6.png)
...
![3D地図](./pic_qgis2_8/15pic_19.png)

ブラウザが立ち上がり、3D地図図が表示される。
![3D地図](./pic_qgis2_8/15pic_20.png)
